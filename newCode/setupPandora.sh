trackperf="${PWD}/PanInstall"

export PATH=${trackperf}/bin:$PATH
export LD_LIBRARY_PATH=${trackperf}/lib:${trackperf}/lib64:$LD_LIBRARY_PATH
export ROOT_INCLUDE_PATH=${trackperf}/include:$ROOT_INCLUDE_PATH
export PYTHONPATH=${trackperf}/python:$PYTHONPATH
cd ..
export PYTHONPATH=${PWD}/digitization:$PYTHONPATH
export PYTHONPATH=${PWD}/reconstruction:$PYTHONPATH
export CMAKE_PREFIX_PATH=${trackperf}:$CMAKE_PREFIX_PATH
cd k4MuCPlayground
