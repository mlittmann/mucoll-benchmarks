...
#define TrackPerfWorkspace_VERSION_MAJOR 1
#define TrackPerfWorkspace_VERSION_MINOR 2
#define TrackPerfWorkspace_VERSION_PATCH 3
#define TrackPerfWorkspace_VERSION 1.2.3
